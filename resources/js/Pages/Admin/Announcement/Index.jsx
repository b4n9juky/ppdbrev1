...
export default function Index({ registrations, paths, stats, filters }) {
    ...
    useEffect(() => {
        ...
        debounceRef.current = setTimeout(() => {
            const params = { ...filters, search, path: pathFilter, status: statusFilter, page: 1 };
            router.get(route('admin.announcement.index'), params, { preserveState: true, preserveScroll: true });
        }, 400);
    ...
    function handlePerPage(value) {
        router.get(route('admin.announcement.index'), {
        ...
        <AuthenticatedLayout
            header={
                <div className="flex items-center gap-3">
                    ...
                    <div>
                        <h2 className="text-xl font-bold text-gray-900">Pengumuman Kelulusan</h2>
                        <p className="text-sm text-gray-500">Kelola status kelulusan pendaftar</p>
                    </div>
                </div>
            }
        >
