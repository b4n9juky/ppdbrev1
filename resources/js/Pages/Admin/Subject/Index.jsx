...
export default function Index({ subjects, academicYears }) {
    ...
    function handleSubmit(e) {
        e.preventDefault();
        if (editing) {
            put(route('admin.subjects.update', editing), {
                preserveScroll: true,
        ...
        <AuthenticatedLayout
            header={
                <div className="flex items-center gap-3">
                    <div className="flex h-10 w-10 items-center justify-center rounded-xl bg-gradient-to-br from-sky-500 to-cyan-600 shadow-lg shadow-sky-200">
                    ...
                    <div>
                        ...
                        <p className="text-sm text-gray-500">Kelola mata pelajaran ujian</p>
                    </div>
                </div>
            }
        >
            ...
            <div className="py-8">
                <div className="mx-auto max-w-4xl sm:px-6 lg:px-8">
                    <div className="mb-8 overflow-hidden rounded-2xl border border-gray-100 bg-white shadow-sm">
                        <div className="border-b border-gray-100 bg-gradient-to-r from-sky-50 to-cyan-50 px-6 py-4">
                    ...
                    <div className="overflow-hidden rounded-2xl border border-gray-100 bg-white shadow-sm">
                        <div className="border-b border-gray-100 bg-gray-50/50 px-6 py-4">
                            <h3 className="text-base font-semibold text-gray-900">Daftar Mata Pelajaran</h3>
                        </div>
                                ...
                                {subjects.map((subject) => (
                                    <tr key={subject.id} className="transition-colors hover:bg-gray-50/50">
                                        ...
                                        <td className="whitespace-nowrap px-6 py-4 text-right text-sm">
                                            ...
                                            <button onClick={() => handleDelete(subject.id)} className="inline-flex items-center gap-1 rounded-lg border border-red-200 bg-red-50 px-3 py-1.5 text-xs font-medium text-red-700 shadow-sm transition hover:bg-red-100 hover:border-red-300 ml-1">
