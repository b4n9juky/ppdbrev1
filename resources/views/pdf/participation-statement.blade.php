...
<head>
    <meta charset="utf-8">
    <title>Surat Pernyataan Partisipasi Orang Tua / Wali Siswa</title>
    <style>
        @page {
            margin: 1in;
        }
...
<body>
    ...
    <div class="container">
        ...
        <div class="title-section">
            <h2>SURAT PERNYATAAN PARTISIPASI ORANG TUA / WALI SISWA</h2>
        </div>
        ...
        <div class="content-text">
            <p>Dengan sungguh-sungguh menyatakan bahwa saya selaku orang tua / wali dari siswa tersebut di atas, menyatakan kesediaan berpartisipasi dalam:</p>
        </div>
